...
fun main(args: Array<String>) {
    ...
    println("Double is greater Than ${numDouble > numInt}") // return true or false
    println("number of greater ${kotlin.math.max(numDouble, numInt.toDouble())}") // return the greater number
